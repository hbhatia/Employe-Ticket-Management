package com.nagarro.ticketmanagement.security.jwt.resource;
...
import com.nagarro.ticketmanagement.security.jwt.JwtTokenUtil;
import com.nagarro.ticketmanagement.security.jwt.JwtUserDetails;
...
//	@Valid
	@PostMapping("/signup")
	public ResponseEntity<?> registerUser(@RequestBody EmployeeDto signUpRequest) {
		if (employeeRepo.existsByUserName(signUpRequest.getUserName())) {
			return ResponseEntity.badRequest().body("Error: Username is already taken!");
		}

		if (employeeRepo.existsByEmpEmail(signUpRequest.getEmpEmail())) {
			return ResponseEntity.badRequest().body("Error: Email is already in use!");
		}
		// Create new user's account
		Employee emp = new Employee();
		emp.setEmpActive(Boolean.TRUE);
		emp.setEmpEmail(signUpRequest.getEmpEmail());
